package org.oldskooler.vibe.web.admin;
...
public final class AdminPageModelFactory {
    ...
    public Map<String, Object> create(Context context, String currentPath) {
        ...
        model.put("canManageSettings", currentAdmin != null && rankPermissionService.hasPermission(currentAdmin.getRank(), RankPermissionKeys.HOUSEKEEPING_SETTINGS));
        return model;
    }
