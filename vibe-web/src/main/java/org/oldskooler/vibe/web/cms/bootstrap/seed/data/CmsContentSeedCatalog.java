package org.oldskooler.vibe.web.cms.bootstrap.seed.data;

import org.oldskooler.vibe.web.cms.article.CmsArticleDraft;
...
public final class CmsContentSeedCatalog {
    ...
    private static final CmsPageDraft HOME_PAGE = new CmsPageDraft(
            ...
            "page",
            "Welcome to Vibe",
            "A modular CMS powered front page for your Vibe hotel.",
            """
            ## Retro hotel, modern workflow

            Vibe-Web ships with draft and publish flows for pages and news.
    ...
    private static final List<CampaignSeed> CAMPAIGNS = List.of(
            new CampaignSeed(
                    ...
                    "Welcome Lounge",
                    "Take a tour of the community spaces and see what Vibe is building next.",
                    0
            ),
            new CampaignSeed(
                    "/news",
