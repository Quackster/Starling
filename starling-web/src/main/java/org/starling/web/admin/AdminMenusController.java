...
import org.starling.web.request.MenuItemRequest;
import org.starling.web.request.MenuRequest;
...
public final class AdminMenusController {
    ...
    public void index(Context context) {
        ...
        model.put("menus", menus.stream().map(cmsViewModelFactory::menu).toList());
        model.put("selectedMenu", cmsViewModelFactory.menu(selectedMenu));
        model.put("items", navigationService.listItems(selectedMenu.id()).stream().map(cmsViewModelFactory::menuItem).toList());
