package org.oldskooler.vibe.client;
...
public final class VibeClient implements AutoCloseable {
    ...
    /**
     * Creates a new VibeClient.
     * @param config the config value
     */
    private VibeClient(Config config) {
        this.config = config;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (VibeClient client = new VibeClient(config)) {
            client.run();
        }
    }
    ...
    private void log(String message) {
        System.out.println("[vibe-client] " + message);
    }
